param(
    [string]$ConfigPath = ".agent/project-fit-orchestrator.json",
    [switch]$Init
)
...
$customizerScript = Join-Path $repoRoot ".agent/skills/project-customizer/scripts/apply-project-customization.ps1"
...
$reportPath = ".agent/reports/project-fit-orchestrator.md"
